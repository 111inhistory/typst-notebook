    ...
    [
      #align(bottom)[
        #block(width: 100%, height: 1.5em)[
          #align(center)[
            #if query(<frontmatter>).len() == 1 and query(<frontmatter>).at(0).value.keys().contains("title") {
...
#let default_latin_font = ("Segoe UI",)
